...
![spring mvc execution flow](https://codesjava.com/wp-content/uploads/2015/12/SpringMVCFlowDiagram-1.jpg?raw=true)

## Spring MVC execution flow (include filter, interceptor)
![spring mvc execution flow2](https://justforchangesake.files.wordpress.com/2014/05/spring-request-lifecycle.jpg?raw=true)
